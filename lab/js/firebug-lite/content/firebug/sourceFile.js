...
Firebug.SourceFile.prototype =
{
    ...
    forEachScript: function(callback)
         ...
         for (var i = 0; i <= lineCount; i++)
         {
             ...
             if (FBTrace.DBG_LINETABLE)
             {
                 ...
                 if (this.outerScriptLineMap.indexOf(mapLineNo) != -1)
                     FBTrace.sysout("lib.SourceFile.addToLineTable ["+mapLineNo+"]="+script.tag+" for scriptLineNo="+scriptLineNo+" vs "+lineFromPC+"=lineFromPC; lineToPc="+pcFromLine+" with mp3="+(this.pcmap_type==PCMAP_PRETTYPRINT?"PP":"SOURCE")+"\n");
                 else
     ...
     // these objects mp3 JSD's values to correct values
