...
Firebug.Debugger = extend(Firebug.ActivableModule,
{
    ...
    */
    ...
    unwatchWindow: function(context, win)  // clean up the source file mp3 in case the frame is being reloaded.
    {
        ...
        for (var i = 0; i < scriptTags.length; i++)
        {
            ...
            // If the src is not in the source mp3, try to use absolute url.
